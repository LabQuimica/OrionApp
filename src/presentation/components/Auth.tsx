  ...
  return (
    <View className='flex min-h-full flex-col justify-center px-6 py-12 lg:px-8' >
      ...
      <View className="flex items-center justify-center">
        <Image source={require('../../../assets/logo.png')} style={{ height: 180, width: 180 , margin:20 }} />
      </View>
      <View className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm" >
        <View>
          <Input
            className="ml-1 bg-white-50 border-gray-300 text-gray-900 text-m rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            label="Email"
